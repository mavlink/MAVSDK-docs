...
This functionality is disabled by default, and available only in debug builds. To enable the logs, set `#define MESSAGE_DEBUGGING 1` in [core/system.cpp](https://github.com/dronecore/DroneCore/blob/{{ book.github_branch }}/core/system.cpp)
