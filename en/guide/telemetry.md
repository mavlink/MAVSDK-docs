...
The code also assumes that you have defined `telemetry`, a shared pointer to an instance of the `Telemetry` class associated with the device (see [Using Plugins](../guide/using_plugins.md)):
```
