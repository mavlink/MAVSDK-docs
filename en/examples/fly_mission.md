...
This example shows how to create, upload, and run missions using DroneCore.

> **Warning** This example is being updated to move from a state machine to a more modern promise/future-based implementation. The new version will show best practice for using the asynchronous API.
>
> The mechanisms shown do work, and in particular the code around defining [Mission](../api_reference/classdronecore_1_1_mission.md) and [MissionItem](../api_reference/classdronecore_1_1_mission_item.md) objects is correct.
