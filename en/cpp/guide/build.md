...
`cmake -DCMAKE_BUILD_TYPE=Debug -B build/default -H.`
...
```bash
cmake -B build/default -H. -DCMAKE_BUILD_TYPE=Release
...
```bash
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=install -B build/default -H.
